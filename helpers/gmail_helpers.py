...
class GmailHelpers:
    ...
    async def list_messages(
        ...
        try:
            service = (
                GmailHelpers._get_service(credentials)
                if credentials
            ...
            while True:
                ...
                if "nextPageToken" not in results or len(messages) >= int(max_results):
                    break
            ...
            return {
                "success": True,
                "messages": messages[: int(max_results)],
    ...
    async def delete_message(
        access_token: str, message_id: str, credentials: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def modify_message(
        ...
        try:
            ...
            return {"success": True, "message": modified_message}
